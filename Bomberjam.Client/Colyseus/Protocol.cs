namespace Bomberjam.Client.Colyseus
{
	...
	public static class Protocol
	{
		...
		/// <summary>When server explicitly removes <see cref="Client"/> from the <see cref="Room{T}"/></summary>
		public static int LEAVE_ROOM = 12;

		/// <summary>When server sends data to a particular <see cref="Room{T}"/></summary>
		public static int ROOM_DATA = 13;

		/// <summary>When server sends <see cref="Room{T}"/> state to its clients.</summary>
